...
**Происхождение.** Dictor — форк проекта
[Parakey](https://github.com/rcourtman/parakey) Ричарда Кортмана под лицензией
MIT: 34 коммита с 18 по 22 июля 2026 года, давшие рабочий цикл «нажал —
сказал — отпустил». Всё, что делает Dictor самостоятельным продуктом, написано
после: интерфейс и дизайн-система, фоновая служба, история, статистика,
словарь, канал обновлений. Это 137 коммитов с 23 июля 2026 года, одним автором.
Список контрибьюторов на GitHub перечисляет всех, чьи коммиты есть в истории,
включая основу форка.
