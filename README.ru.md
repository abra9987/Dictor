...
MIT. Parakey сделал главное: диктовку, которая распознаёт речь целиком на
машине. Эта основа ввезена сюда одним коммитом, её копирайт сохранён в
[LICENSE](LICENSE) и [NOTICE.md](NOTICE.md). Всё, что идёт после, — интерфейс
и дизайн-система, фоновая служба, история, статистика, словарь, канал
обновлений — написано для Dictor одним автором, начиная с 23 июля 2026 года.
